(async()=>{
  ...
  const css=await read(['/parts/basecss-01.txt','/parts/basecss-02.txt','/parts/basecss-03.txt','/parts/fincss-01.txt','/ui-fixes.css?v=1017-fix7']);
  ...
  await loadScript('/cloud-router-store.js?v=1017-fix7');
  await loadScript('/cloud-adapter.js?v=1017-fix7');
  ...
  await loadScript('/ui-runtime-fixes.js?v=1017-fix7');
