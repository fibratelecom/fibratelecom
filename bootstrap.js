...
(async()=>{
  ...
  const BUILD_TOKEN='20260831-integration-system1';
  ...
  await loadScript('/dashboard-transition-guard.js?v=20260831-integration-system1').catch(error=>console.error('Provedor Plus: os hubs de navegação não foram carregados.',error));
