(async()=>{
  ...
  const BUILD_TOKEN='20260831-bankapi2';
  ...
  await loadScript('/dashboard-transition-guard.js?v=20260831-bankapi2').catch(error=>console.error('Provedor Plus: a proteção de transição do Dashboard não foi carregada.',error));
