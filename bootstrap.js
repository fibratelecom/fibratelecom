(async()=>{
  ...
  const auth=await window.ProvedorPlusAuth.ensure();window.ProvedorPlusCurrentUser=auth?.user||null;
  ...
  window.ProvedorPlusCloudState.setState(currentState,{sync:false});
