...
export function shellTemplate(user){
  ...
  const mapLink=hasPermission(user,'network')?'<a class="module-tab" href="/mapa" style="text-decoration:none"><span>⌖</span>Mapa</a>':'';
